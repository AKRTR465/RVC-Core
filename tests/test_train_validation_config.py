...
""",
            ...
            self.assertTrue(config["training_files"].endswith("train_filelist.txt"))
            self.assertTrue(config["validation_files"].endswith("val_filelist.txt"))
            self.assertEqual(config["data"]["training_files"], config["training_files"])
            self.assertEqual(config["data"]["validation_files"], config["validation_files"])
